...
export class ObservableCourierApi {
     ...
     */
    public listCourierMessages(page_size?: number, page_token?: string, status?: CourierMessageStatus, recipient?: string, _options?: Configuration): Observable<Array<Message>> {
        const requestContextPromise = this.requestFactory.listCourierMessages(page_size, page_token, status, recipient, _options);
...
export class ObservableFrontendApi {
     ...
     */
    public createBrowserLoginFlow(refresh?: boolean, aal?: string, return_to?: string, Cookie?: string, login_challenge?: string, _options?: Configuration): Observable<LoginFlow> {
        const requestContextPromise = this.requestFactory.createBrowserLoginFlow(refresh, aal, return_to, Cookie, login_challenge, _options);
     ...
     */
    public createBrowserLogoutFlow(cookie?: string, return_to?: string, _options?: Configuration): Observable<LogoutFlow> {
        const requestContextPromise = this.requestFactory.createBrowserLogoutFlow(cookie, return_to, _options);
     ...
     * @param return_to The URL to return the browser to after the flow was completed.
     */
    public createBrowserRecoveryFlow(return_to?: string, _options?: Configuration): Observable<RecoveryFlow> {
        const requestContextPromise = this.requestFactory.createBrowserRecoveryFlow(return_to, _options);
     ...
     */
    public createBrowserRegistrationFlow(return_to?: string, login_challenge?: string, after_verification_return_to?: string, _options?: Configuration): Observable<RegistrationFlow> {
        const requestContextPromise = this.requestFactory.createBrowserRegistrationFlow(return_to, login_challenge, after_verification_return_to, _options);
     ...
     * @param Cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    public createBrowserSettingsFlow(return_to?: string, Cookie?: string, _options?: Configuration): Observable<SettingsFlow> {
        const requestContextPromise = this.requestFactory.createBrowserSettingsFlow(return_to, Cookie, _options);
     ...
     * @param return_to The URL to return the browser to after the flow was completed.
     */
    public createBrowserVerificationFlow(return_to?: string, _options?: Configuration): Observable<VerificationFlow> {
        const requestContextPromise = this.requestFactory.createBrowserVerificationFlow(return_to, _options);
     ...
     * @param return_to The URL to return the browser to after the flow was completed.
     */
    public createNativeLoginFlow(refresh?: boolean, aal?: string, X_Session_Token?: string, return_session_token_exchange_code?: boolean, return_to?: string, _options?: Configuration): Observable<LoginFlow> {
        const requestContextPromise = this.requestFactory.createNativeLoginFlow(refresh, aal, X_Session_Token, return_session_token_exchange_code, return_to, _options);
     ...
     * @param return_to The URL to return the browser to after the flow was completed.
     */
    public createNativeRegistrationFlow(return_session_token_exchange_code?: boolean, return_to?: string, _options?: Configuration): Observable<RegistrationFlow> {
        const requestContextPromise = this.requestFactory.createNativeRegistrationFlow(return_session_token_exchange_code, return_to, _options);
     ...
     * @param X_Session_Token The Session Token of the Identity performing the settings flow.
     */
    public createNativeSettingsFlow(X_Session_Token?: string, _options?: Configuration): Observable<SettingsFlow> {
        const requestContextPromise = this.requestFactory.createNativeSettingsFlow(X_Session_Token, _options);
     ...
     */
    public disableMyOtherSessions(X_Session_Token?: string, Cookie?: string, _options?: Configuration): Observable<DeleteMySessionsCount> {
        const requestContextPromise = this.requestFactory.disableMyOtherSessions(X_Session_Token, Cookie, _options);
     ...
     * @param Cookie Set the Cookie Header. This is especially useful when calling this endpoint from a server-side application. In that scenario you must include the HTTP Cookie Header which originally was included in the request to your server. An example of a session in the HTTP Cookie Header is: &#x60;ory_kratos_session&#x3D;a19iOVAbdzdgl70Rq1QZmrKmcjDtdsviCTZx7m9a9yHIUS8Wa9T7hvqyGTsLHi6Qifn2WUfpAKx9DWp0SJGleIn9vh2YF4A16id93kXFTgIgmwIOvbVAScyrx7yVl6bPZnCx27ec4WQDtaTewC1CpgudeDV2jQQnSaCP6ny3xa8qLH-QUgYqdQuoA_LF1phxgRCUfIrCLQOkolX5nv3ze_f&#x3D;&#x3D;&#x60;.  It is ok if more than one cookie are included here as all other cookies will be ignored.
     */
    public disableMySession(id: string, X_Session_Token?: string, Cookie?: string, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.disableMySession(id, X_Session_Token, Cookie, _options);
     ...
     */
    public exchangeSessionToken(init_code: string, return_to_code: string, _options?: Configuration): Observable<SuccessfulNativeLogin> {
        const requestContextPromise = this.requestFactory.exchangeSessionToken(init_code, return_to_code, _options);
     ...
     * @param Cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    public getSettingsFlow(id: string, X_Session_Token?: string, Cookie?: string, _options?: Configuration): Observable<SettingsFlow> {
        const requestContextPromise = this.requestFactory.getSettingsFlow(id, X_Session_Token, Cookie, _options);
     ...
     * @param Cookie Set the Cookie Header. This is especially useful when calling this endpoint from a server-side application. In that scenario you must include the HTTP Cookie Header which originally was included in the request to your server. An example of a session in the HTTP Cookie Header is: &#x60;ory_kratos_session&#x3D;a19iOVAbdzdgl70Rq1QZmrKmcjDtdsviCTZx7m9a9yHIUS8Wa9T7hvqyGTsLHi6Qifn2WUfpAKx9DWp0SJGleIn9vh2YF4A16id93kXFTgIgmwIOvbVAScyrx7yVl6bPZnCx27ec4WQDtaTewC1CpgudeDV2jQQnSaCP6ny3xa8qLH-QUgYqdQuoA_LF1phxgRCUfIrCLQOkolX5nv3ze_f&#x3D;&#x3D;&#x60;.  It is ok if more than one cookie are included here as all other cookies will be ignored.
     */
    public listMySessions(per_page?: number, page?: number, X_Session_Token?: string, Cookie?: string, _options?: Configuration): Observable<Array<Session>> {
        const requestContextPromise = this.requestFactory.listMySessions(per_page, page, X_Session_Token, Cookie, _options);
     ...
     * @param Cookie Set the Cookie Header. This is especially useful when calling this endpoint from a server-side application. In that scenario you must include the HTTP Cookie Header which originally was included in the request to your server. An example of a session in the HTTP Cookie Header is: &#x60;ory_kratos_session&#x3D;a19iOVAbdzdgl70Rq1QZmrKmcjDtdsviCTZx7m9a9yHIUS8Wa9T7hvqyGTsLHi6Qifn2WUfpAKx9DWp0SJGleIn9vh2YF4A16id93kXFTgIgmwIOvbVAScyrx7yVl6bPZnCx27ec4WQDtaTewC1CpgudeDV2jQQnSaCP6ny3xa8qLH-QUgYqdQuoA_LF1phxgRCUfIrCLQOkolX5nv3ze_f&#x3D;&#x3D;&#x60;.  It is ok if more than one cookie are included here as all other cookies will be ignored.
     */
    public toSession(X_Session_Token?: string, Cookie?: string, _options?: Configuration): Observable<Session> {
        const requestContextPromise = this.requestFactory.toSession(X_Session_Token, Cookie, _options);
     ...
     * @param Cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    public updateLoginFlow(flow: string, UpdateLoginFlowBody: UpdateLoginFlowBody, X_Session_Token?: string, Cookie?: string, _options?: Configuration): Observable<SuccessfulNativeLogin> {
        const requestContextPromise = this.requestFactory.updateLoginFlow(flow, UpdateLoginFlowBody, X_Session_Token, Cookie, _options);
     ...
     * @param Cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    public updateLogoutFlow(token?: string, return_to?: string, Cookie?: string, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.updateLogoutFlow(token, return_to, Cookie, _options);
     ...
     * @param Cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    public updateSettingsFlow(flow: string, UpdateSettingsFlowBody: UpdateSettingsFlowBody, X_Session_Token?: string, Cookie?: string, _options?: Configuration): Observable<SettingsFlow> {
        const requestContextPromise = this.requestFactory.updateSettingsFlow(flow, UpdateSettingsFlowBody, X_Session_Token, Cookie, _options);
...
export class ObservableIdentityApi {
     ...
     */
    public deleteIdentityCredentials(id: string, type: 'totp' | 'webauthn' | 'lookup', _options?: Configuration): Observable<void> {
     ...
     */
    public getIdentity(id: string, include_credential?: Array<'password' | 'totp' | 'oidc' | 'webauthn' | 'lookup_secret'>, _options?: Configuration): Observable<Identity> {
        const requestContextPromise = this.requestFactory.getIdentity(id, include_credential, _options);
     ...
     */
    public listIdentities(per_page?: number, page?: number, credentials_identifier?: string, _options?: Configuration): Observable<Array<Identity>> {
        const requestContextPromise = this.requestFactory.listIdentities(per_page, page, credentials_identifier, _options);
     ...
     * @param page Pagination Page  This value is currently an integer, but it is not sequential. The value is not the page number, but a reference. The next page can be any number and some numbers might return an empty list.  For example, page 2 might not follow after page 1. And even if page 3 and 5 exist, but page 4 might not exist.
     */
    public listIdentitySchemas(per_page?: number, page?: number, _options?: Configuration): Observable<Array<IdentitySchemaContainer>> {
        const requestContextPromise = this.requestFactory.listIdentitySchemas(per_page, page, _options);
     ...
     */
    public listIdentitySessions(id: string, per_page?: number, page?: number, active?: boolean, _options?: Configuration): Observable<Array<Session>> {
        const requestContextPromise = this.requestFactory.listIdentitySessions(id, per_page, page, active, _options);
     ...
     */
    public listSessions(page_size?: number, page_token?: string, active?: boolean, expand?: Array<string>, _options?: Configuration): Observable<Array<Session>> {
        const requestContextPromise = this.requestFactory.listSessions(page_size, page_token, active, expand, _options);
...
export class ObservableMetadataApi {
     ...
     */
    public isAlive(_options?: Configuration): Observable<IsAlive200Response> {
     ...
     */
    public isReady(_options?: Configuration): Observable<IsAlive200Response> {
