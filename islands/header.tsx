...
const Header = () => {
  ...
  const headerClass = useMemo(() => {
    return cn(
      ...
      isWindowScrolled ? "bg-primary-black border-gray-900" : "border-transparent pt-8"
    )
  }, [isWindowScrolled])
    ...
    <header class={headerClass}>
      <div class="container mx-auto flex flex-wrap items-center justify-between relative border-gray-100">
        ...
        <div
          ...
          <nav class={`lg:mr-8 lg:space-x-4 ${isOpen ? "flex flex-col items-center lg:block mb-4 lg:mb-0" : "block"}`}>
            {NavList.map((item) => (
